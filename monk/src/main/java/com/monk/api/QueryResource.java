...
import com.monk.search.SearchExecutionService;
...
@Tag(name = "Queries", description = "Translate and execute search queries using the monk DSL")
public class QueryResource {
    ...
    @Operation(summary = "Query DSL JSON Schema", description = "Returns the JSON Schema that fully describes the monk query DSL. Field properties are constrained to the field names declared in the currently loaded mappings.")
